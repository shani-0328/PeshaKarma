                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="text-lg-right mt-3 mt-lg-0">
                                            <a href="{{url('/admin/departmentlisttable')}}" type="button" class="btn btn-light waves-effect waves-light mr-1"><i class="mdi mdi-format-list-bulleted"></i></a>
                                            <a href="{{url('/admin/departmentlist')}}" type="button" class="btn btn-success waves-effect waves-light mr-1"><i class="mdi mdi-view-dashboard-outline"></i></a>
                                        </div>
                                    </div>
                                    <!-- end col-->
                                </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card-box bg-pattern">
                                <div class="text-center">
                                    <img src="../assets/images/companies/agr.jpg" alt="logo" class="avatar-xl rounded-circle mb-3">
                                    <h4 class="mb-1 font-16">{{$department->name}}</h4>
                                    <p class="text-muted  font-14">Kandy, Central Provincial</p>
                                </div>



                                <div class="text-center">
                                    <a href="{{url('/admin/institutionlist', $department->id)}}" class="btn btn-sm btn-light" data-toggle="tooltip" data-placement="top" title="View Institutions">View List</a>
                                </div>

                                <div class="row mt-4 text-center">
                                    <div class="col-6">
                                        <h5 class="font-weight-normal text-muted font-13">Precentage</h5>
                                        <h4>{{round($department->percentage,0)}}%</h4>
                                    </div>
                                    <div class="col-6">
                                        <h5 class="font-weight-normal text-muted font-13">Institution</h5>
                                        <h4>{{$departmentse->total_institutions}}</h4>
                                    </div>
                                </div>
                            </div>
