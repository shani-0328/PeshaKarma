        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- end page title -->
                    @if(Session::has('Add_institution'))
				
                <div class="alert alert-primary alert-dismissible fade show" role="alert">
                    <strong>Success!</strong> {{session('Add_institution')}}
				...
				@endif
                @if(Session::has('edit_institution'))
                <div class="alert alert-info alert-dismissible fade show" role="alert">
                    <strong>Success!</strong> {{session('edit_institution')}}
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
				...
				@endif
                @if(Session::has('delete_institution'))
				<div class="alert alert-danger alert-dismissible fade show" role="alert">
                    <strong>Success!</strong> {{session('delete_institution')}}
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row mb-2">
                                        <div class="col-sm-4">
                                            <a href="{{url('/admin/institutions/create')}}" class="btn btn-danger mb-2"><i class="mdi mdi-plus-circle mr-2"></i> Add Institution</a>
                                        </div>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-centered table-striped dt-responsive nowrap w-100" id="institution-datatable">
                                            <thead>
                                                <tr>
                                                    <th style="width: 20px;">
                                            ...
                                            @foreach($institutions as $institution)
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{$institution->department ? $institution->department->name:''}}
                                                    </td>
                                                    <td>
                                                
                                                        <a href="{{route('institutions.edit', $institution->id)}}" type="button" class="btn btn-link action-icon" data-toggle="tooltip" data-placement="top" title="Edit Institution"> <i class="mdi mdi-square-edit-outline"></i></a>
                                                        @if(auth()->user()->role->name == 'SuperAdmin')   
                                                               <a href="{{url('/institution/delete', $institution->id)}}" class="button btn btn-link action-icon delete-confirm"><i class="mdi mdi-delete" data-toggle="tooltip" data-placement="top" title="Delete"></i></a>
                                                        @endif
                                                    </td>
                                                </tr>
                                            @endforeach
