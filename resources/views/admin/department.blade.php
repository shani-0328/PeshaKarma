...
<body>
        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="alert alert-primary alert-dismissible fade show" role="alert">
                    <strong>Success!</strong> {{session('Add_department')}}
				...
				@endif
                @if(Session::has('edit_department'))
                <div class="alert alert-info alert-dismissible fade show" role="alert">
                    <strong>Success!</strong> {{session('edit_department')}}
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
				...
				<div class="alert alert-danger alert-dismissible fade show" role="alert">
                    <strong>Success!</strong> {{session('delete_department')}}
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row mb-2">
                                        <div class="col-sm-4">
                                            <a href="{{url('/admin/departments/create')}}" class="btn btn-danger mb-2"><i class="mdi mdi-plus-circle mr-2"></i> Add Department</a>
                                        </div>
                                        <div class="col-sm-8">
                                        ...
                                        @foreach($departments as $department)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{(route('departments.edit', $department->id))}}"  type="button" class="btn btn-link action-icon" data-toggle="tooltip" data-placement="top" title="Edit Department"> <i class="mdi mdi-square-edit-outline"></i></a>
                                                       
                                                        
                                                        @if(auth()->user()->role->name == 'SuperAdmin')
                                                        <a href="{{url('/department/delete', $department->id)}}" class="button btn btn-link action-icon delete-confirm"><i class="mdi mdi-delete" data-toggle="tooltip" data-placement="top" title="Delete"></i></a>
                                                        @endif
                                                    </td>
                                                </tr>
                                            @endforeach
    ...
    <!-- Datatables init -->
    <script src="{{URL::asset('../assets/js/pages/department.init.js')}}"></script>
...
<script>
 $('.delete-confirm').on('click', function (event) {
    ...
    swal({
        title: 'Are you sure?',
        text: 'This Department and it`s details will be permanantly deleted!',
        icon: 'warning',
        buttons: ["Cancel", "Yes!"],
    }).then(function(value) {
        if (value) {
