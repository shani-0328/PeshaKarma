                                        ...
                                        <table class="table table-centered table-striped dt-responsive nowrap w-100" id="managecustomers">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Customer</th>
                                                    <th>Gov ID #</th>
                                                    <th style="text-align: center; width: 100px;">Tot Amount</th>
                                            ...
                                            @foreach($customers as $customer)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    <button class="btn btn-primary btn-sm" disabled> <i class="mdi mdi-plus-circle"></i> Add Payment</button>
                                                    </td>
                                                    @else
                                                    <td>
                                                    <a href="{{url('/admin/installment-payment/create',$customer->id)}}"  type="button" class="btn btn-primary btn-sm"> <i class="mdi mdi-plus-circle"></i> Add Payment</a>
                                                    </td>
