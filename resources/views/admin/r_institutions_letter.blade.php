                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row mb-2">
                                        <div class="col-sm-4">
                                            <h4 class="page-title">Institutions List</h4>
                                        </div>
                                        <div class="col-sm-8">
                                        ...
                                        <table class="table table-striped dt-responsive nowrap w-100" id="example">
                                            ...
                                            @foreach($institutions as $institution)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    <b><a href="{{url('/admin/letter-report', $institution->id)}}" data-toggle="tooltip" data-placement="bottom" title="View">{{$institution->name}}</a></b>
                                                    </td>
