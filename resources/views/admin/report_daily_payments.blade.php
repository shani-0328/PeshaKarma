                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row mb-2">
                                        <div class="col-sm-4">
                                         <h4 class="page-title">Daily payments Report</h4>
                                        </div>
                                        <div class="col-sm-8">
                                        ...
                                        <table class="table table-striped dt-responsive nowrap w-100" id="example">
                                            ...
                                            @foreach($payments as $payment)   
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{$payment->customer->institution ? $payment->customer->institution->code:''}}
                                                    </td>
                                                    <td>
                                                        {{$payment->customer->institution ? $payment->customer->institution->name:''}}
                                                    </td>
                                                    <td>
                                                        {{$payment->paid_option}}
                                                    </td>
