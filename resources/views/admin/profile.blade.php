                    ...
                    <div class="row">
                        <div class="col-lg-4 col-xl-4">
                            <div class="card-box text-center">
                                <img src="{{asset('../assets/images/users/unnamed.png')}}" class="rounded-circle avatar-lg img-thumbnail" alt="profile-image">

                                @if(Auth::check())
                                <h4 class="mb-0 font-16">{{Auth()->user()->name}}</h4>
                                <p class="text-muted">Department of Textile</p>
                                @endif
                                ...
                                <div class="text-left mt-3">
                                    ...
                                    <p class="text-muted mb-2 font-13"><strong>Mobile :</strong><span class="ml-2">{{Auth()->user()->phone_number}}</span></p>

                                    <p class="text-muted mb-2 font-13"><strong>Email :</strong> <span class="ml-2 ">{{Auth()->user()->email}}</span></p>

                                    <p class="text-muted mb-1 font-13"><strong>Location :</strong> <span class="ml-2">Kandy</span></p>
                                </div>
                        ...
                        <div class="col-lg-8 col-xl-8">
                            <div class="card-box">
                                <ul class="nav nav-pills navtab-bg nav-justified">
                                    ...
                                    <li class="nav-item">
                                        <a href="#passwordchange" data-toggle="tab" aria-expanded="true" class="nav-link active">
                                                Change Password
                                            </a>
                                    </li>
                                ...
                                <div class="tab-content">
                                    ...
                                    {!! Form::model(Auth()->user(), ['method'=>'POST' , 'action'=>['App\Http\Controllers\UsersController@profileupdate',Auth()->user()->id]]) !!}
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        {!! Form:: text('name',  isset($user) ? $user : '',['class'=>'form-control', 'required'=> 'true']) !!}
                                                        @endif
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                <div class="form-group">
                                                        ...
                                                        {!! Form:: email('email',  isset($user) ? $user : '',['class'=>'form-control', 'required'=> 'true', 'placeholder'=> 'sample@mail.com','readonly'=>'true']) !!}
                                                        @endif
                                                        <span class="form-text text-muted"><small>If you want to change email please contact <b>Admin</b></small></span>
                                                    </div>
                                                </div>
                                                <!-- end col -->
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        @if($user =Auth::user()->phone_number)
                                                        {!! Form:: number('phone_number',  isset($user) ? $user : '',['class'=>'form-control', 'required'=> 'true', 'placeholder'=> '07XXXXXXXX']) !!}
                                                        @endif
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                    ...
                                    {!! Form::model(Auth()->user(), ['method'=>'POST' , 'action'=>['App\Http\Controllers\UsersController@passwordupdate',Auth()->user()->id]]) !!}
                                            <h5 class="mb-4 text-uppercase bg-light p-2"><i class="mdi mdi-lock mr-1"></i> Change Password</h5>
                                            <div class="row">
                                                <div class="col-md-8">
                                                <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-merge">
                                                            ...
                                                            {!! Form:: password('old_password',['class'=>'form-control', 'id'=>'adduserpassword', 'placeholder'=> 'Password']) !!}
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-merge">
                                                        {!! Form:: password('password',['class'=>'form-control','id'=>'adduserpassword', 'placeholder'=> 'Password']) !!}
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-merge">
                                                        {!! Form:: password('c_password',['class'=>'form-control', 'id'=>'adduserpassword', 'placeholder'=> 'Password']) !!}
                                            ...
                                            <div class="text-left">
                                                <button type="submit" class="btn btn-primary waves-effect waves-light mt-2"><i class="mdi mdi-key-variant"></i> Change Password</button>
                                            </div>
                                        {!! Form::close() !!}
                                    </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            </script> &copy; Systems by <a href="syscodtech.com">SysCodtech</a>
                        </div>
                        <div class="col-md-6">
