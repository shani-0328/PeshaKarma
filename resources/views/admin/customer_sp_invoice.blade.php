                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-centered table-striped dt-responsive nowrap w-100" id="managecustomers">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="table-user">
                                                        <a href="" class="text-body font-weight-semibold" style="text-transform: uppercase;">{{$invoice->customer->initials}} {{$invoice->customer->last_name}}</a>
                                                    </td>
                                                    <td>
                                                        {{$invoice->customer->Gov_ID}}
                                                    </td>
                                                    ...
                                                    <td>
                                                        {{$invoice->customer ? $invoice->customer->special_invoice_count:''}}
                                                    ...
                                                    <td style="text-align: right">
                                                       {{round($invoice->customer->total_loan_amount,2)}} 
                                                    </td>

                                                    <td style="text-align: center">
                                                       {{round($invoice->customer->total_paid_percentage,0)}}%
                                                    </td>
