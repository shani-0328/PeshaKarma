                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <ul class="nav nav-pills">
                                        <li class="nav-item">
                                            <a class="nav-link active" data-toggle="pill" href="#home">English</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="pill" href="#menu1">සිංහල</a>
                                        </li>
                                    </ul>
                            ...
                            <div class="tab-content">
                                    ...
                                    <button type="button" class="btn btn-secondary btn-sm" onclick="printDiv('printableArea')"><i class="fas fa-print"></i> Print</button>
 
                                <div id="printableArea" class="mt-3" style="">
                                    <p style="font-size: 18px; font-weight: bold;">My No: PTD/ACCT/CS</p>
                                    <p style="font-size: 18px;">
                                        Accountant,<br>
                                        Department of Textile Industries,<br>
                                        No 31, Pushpadana Road,<br>
                                        Bahirawakanda,<br>
                                        Kandy,
                                        <p style="font-size: 18px;"><span id="current_month"></span> <span id="current_day"></span>, <span id="current_year"></span></p>
                                    ...
                                    <p style="font-size: 18px; font-weight: bold;">Code: {{$institution->code}}</p>
                                    <p style="text-align: center; font-size: 19px;"><b><u>Recovery Installments for the fabric purchased under credit facility 2021</b></u></p>

                                    <p style="font-size: 18px;">I think the staff of your organization for the purchase of handloom materiais from this Department on credit facilities. I would assist to recover the installments as follows. Please follow the instructions on the attached circuiar.</p>
                                    
                                    <div class="table-responsive" >
                                    
                                        <table class="table table-striped dt-responsive nowrap w-100 table-sm" id="example">
                                            <thead style="font-size: 17px;">
                                                <tr >
                                                    <th>Name</th>
                                                    <th>I_Code</th>
                                                    <th>Post</th>
                                                    <th style="text-align: center">Instalment</th>
                                            ...
                                            @foreach($customers as $customer)
                                                @if ($customer->total_loan_amount != 0)                                          
                                                    <tr style="font-size: 16px;">
                                                        ...
                                                        <td>
                                                            {{$customer->initials}} {{$customer->last_name}}
                                                        </td>
                                                        <td>
                                                            {{$customer->Gov_ID}}
                                                        </td>
                                                        ...
                                                        <td style="text-align: right">
                                                            {{$customer->total_loan_amount/8}}
                                                        </td>
                                                        <td style="text-align: right">
                                                            {{$customer->total_loan_amount}}
                                                        </td>     
                                                    </tr>
                                                @endif
                                            @endforeach
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <th colspan="4" style="text-align:left; font-size: 18px;">Total:</th>
                                    ...
                                    <p>This computer generated advice does not carry a signature.</p>

                                    </div>
  
                                </div>
                                    <div class="tab-pane container fade" id="menu1">
                                    <button type="button" class="btn btn-secondary btn-sm" onclick="printDiv('printableArea-sinhala')"><i class="fas fa-print"></i> Print</button>
 
 <div id="printableArea-sinhala" class="mt-3">
     ...
     <p style="font-size: 18px;">
         අධ්‍යක්ෂක ,<br>
         පළාත් පේෂකර්මාන්ත දෙපාර්තමේන්තුව,<br>
         අංක 31, පුෂ්පදාන මාවත ,<br>
         බහිරවකන්ද ,<br>
         මහනුවර ,
     </p>
     <p style="font-size: 18px; font-weight: bold;">Code: {{$institution->code}}</p>
     <p style="text-align: center; font-size: 19px;"><b><u>2021 ණය පදනම යටතේ අලෙවි කරන ලද රෙදිපිළි වෙනුවෙන් වූ  ණය වාරික ප්‍රේෂණය කිරීම</b></u></p>

     <p style="font-size: 18px;">මෙමෙ ආයතනයේ / පාසලේ නිලධාරීන් 2021 වර්ෂයේ ණය පදනම යටතේ ලබාගත් රෙදිපිළි සදහා _________________ මාසයේ ගෙවිය යුතු වාරික මුදල ට අදාල අංක __________________________ හා __________________________ දින දරණ රු : වටිනා චෙක්පත මේ සදහා එවමි</p>
     <p style="font-size: 18px;">ආයතනය / පාසල නම සහ ලිපිනය _____________________________________________________________________________________________________________________________</p>
     
     <div class="table-responsive" >
     
         <table class="table table-striped dt-responsive nowrap w-100 table-sm" id="example1">
             <thead>
                 <tr style="font-size: 17px;">
                     <th>නම</th>
                     <th>ජා.හැ අංකය</th>
                     <th>තනතුර </th>
                     <th style="text-align: center">ණය වාරිකය </th>
                     <th style="text-align: center">මුළු ණය</th>
             ...
             <tfoot>
                 <tr>
                     <th colspan="4" style="text-align:left; font-size: 18px;">එකතුව:</th>
                     <th style="text-align:right; font-size: 18px;"></th>
                 </tr>
         </tfoot>
         </table>
     ...
     <p style="font-size: 18px; margin-top: 10px;"> දෙපාර්තමේන්තු ප්‍රධානියාගේ අත්සන   _______________________</p>
...
$(document).ready(function() {
  $('#example').DataTable({
    ...
    "footerCallback": function(row, data, start, end, display) {
      ...
      $('#total').text('Rs ' + Number(pageTotal).toFixed(2));
    }
  });
});
