    ...
    <div class="row">
        ...
        <div class="col-lg-10">
            <div class="card">
                ...
                {!! Form::model($customer, ['method'=>'PATCH' , 'action'=>['App\Http\Controllers\InvoiceController@update',$customer->id]]) !!}
                    <!-- {!! Form::open(['method'=>'POST' , 'action'=>'App\Http\Controllers\InvoiceController@store']) !!} -->
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                {!! Form:: number('number_of_installments', 8,['class'=>'form-control', 'required'=> 'true', 'min'=> '1', 'max'=> '8']) !!}
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select id="payment_method" class="form-control" name ="payment_method"required>
                                    ...
                                    <option>Deduct by Salary</option>
...
<!-- content -->
    ...
    function sum() {
       var txtLoanAmount = document.getElementById('loan_amount').value;
...
$(function(){
    ...
    function calculate(){
        var pPos = parseInt($('#loan_amount').val()); 
