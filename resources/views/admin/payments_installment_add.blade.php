...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Installment Payments</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
    @if(Session::has('Add_payment'))
                ...
                <div class="alert alert-primary alert-dismissible fade show" role="alert">
                    <strong>Success!</strong> {{session('Add_payment')}}
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    <h4 class="mb-3 header-title">Add Payment</h4>

               
                    {!! Form::model($customer, ['method'=>'PATCH' , 'action'=>['App\Http\Controllers\PaymentController@update',$customer->id]]) !!}

                        <div class="form-row">

                        <div class="form-group col-md-6 d-none">
                            <label for="inputgovid" class="col-form-label">Customer ID #</label>
                            {!! Form:: text('customer_id', $cus_id,['class'=>'form-control', 'required'=> 'true','readonly'=>'true']) !!}
                          
                            </div>
                        <div class="form-group col-md-6">
                            <label for="inputgovid" class="col-form-label">Customer Gov ID #</label>
                            {!! Form:: text('customer_gov_id', $cus_gov_id,['class'=>'form-control', 'required'=> 'true','readonly'=>'true']) !!}
                          
                            </div>
                             <div class="form-group col-md-6">

                             <label for="inputgovid" class="col-form-label">Last Name</label>
                             {!! Form:: text('name', $cus_last_name,['class'=>'form-control', 'required'=> 'true','readonly'=>'transliterator_create_from_rules']) !!}
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <label for="inputnumber4" class="col-form-label">Date</label>
                                {!! Form:: date('payment_date', null,['class'=>'form-control', 'required'=> 'true']) !!}
                                <span class="font-13 text-danger">Please double check Payment Date</span>

                            </div>

                            <div class="form-group col-md-6 d-none">

                                <label for="inputnumber4" class="col-form-label">First Payment Date</label>
                                {!! Form:: date('first_payment_date', $current_date,['class'=>'form-control', 'required'=> 'true','readonly'=>'true']) !!}

                            </div>
                            <div class="cheque form-group col-md-6">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="inputpost4" class="col-form-label">Amount</label>
                                {!! Form:: number('amount', null,['class'=>'form-control', 'required'=> 'true','step'=>'0.01']) !!}

                            </div>
                            <div class="form-group col-md-6">
                            <label for="inpurinvoiceid" class="col-form-label">Payment Option</label>
                                <select id="inpurinvoiceid" class="form-control" name="paid_option" required>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <label for="inputnumber4" class="col-form-label">Ref Number</label>
                                {!! Form:: number('reference_number', null,['class'=>'form-control', 'required'=> 'true']) !!}
                            ...
                            <div class="cheque form-group col-md-6">
                                <label for="inputpost4" class="col-form-label">Cheque Number</label>
                        ...
                        <a href="{{route('installment-payment.index')}}" type="button" class="btn btn-danger waves-effect waves-light float-right">Cancel</a>
...
<!-- content -->
        ...
        $(document).on('change','.Gov_id' , function(){
            ...
            $.ajax({
                ...
                success:function(data){
                        ...
                        // op+='<option value="0" selected disabled> Chose institution</option>';
                        for(var i=0; i<data.length;i++){
                            op += '<option value="'+data[i].id+'">'+data[i].
                            last_name+'</option>';
                        }

                        div.find('.invoice').html("");
                        div.find('.invoice').append(op);
                },
                error:function(){
    ...
    $('#inpurinvoiceid').change(function(){ 
    if($(this).val() == "Cheque" )
    {
        $('.cheque').show();
    }
