...
<head>
    <meta charset="utf-8" />
    <title>Departments - Textile</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="mb-3 header-title">Add Departments</h4>

                                    {!! Form::open(['method'=>'POST' , 'action'=>'App\Http\Controllers\DepartmentController@store']) !!}
                                        <div class="form-group">
                                            <label for="exampleInputcode1">Departments Code</label>
                                            {!! Form:: text('code', null,['class'=>'form-control', 'required'=> 'true', 'placeholder'=> 'Department Code']) !!}
                                            @if($errors->has('code'))
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputname1">Departments Name</label>
                                            {!! Form:: text('name', null,['class'=>'form-control', 'required'=> 'true', 'placeholder'=> 'Department Name']) !!}
                                            @if($errors->has('name'))
                                          <small class = "text-danger">
                                            {{$errors->first('name')}}
                                          </small>
                                        ...
                                        <a href="{{url('/admin/departments')}}" type="button" class="btn btn-danger waves-effect waves-light float-right">Cancel</a>
                                    {!! Form::close() !!}
