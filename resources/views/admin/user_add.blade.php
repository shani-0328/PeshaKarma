                                    ...
                                    {!! Form::open(['method'=>'POST' , 'action'=>'App\Http\Controllers\UsersController@store']) !!}
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                {!! Form:: email('email', null,['class'=>'form-control', 'required'=> 'true', 'placeholder'=> 'sample@mail.com']) !!}
                                                @if($errors->has('email'))
                                          <small class = "text-danger">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="inputnumber4" class="col-form-label">Phone Number</label>
                                                <!-- <input type="tel" pattern=".{10}" class="form-control" id="inputnumber4" placeholder="0123456789" oninput="check(this)" required> -->
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                {!! Form:: password('password',['class'=>'form-control', 'required'=> 'true','id'=>'adduserpassword', 'placeholder'=> 'Password']) !!}<br>
                                                ...
                                                <div class="custom-control custom-checkbox">
                                                    ...
                                                    <label class="custom-control-label" for="customCheck11" onclick="myFunction()">Show Password</label>
                                                </div>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                {!! Form:: select('role_id', [''=>'-- Choose User Role --'] + $roles , null,['class'=>'form-control', 'required'=> 'true']) !!}
                                            </div>


                                        </div>
                                        <button type="submit" class="btn btn-primary waves-effect waves-light"><i class="mdi mdi-content-save-all-outline"></i> Save</button>
                                        <a href="{{url('/admin/users')}}" type="button" class="btn btn-danger waves-effect waves-light float-right">Cancel</a>
