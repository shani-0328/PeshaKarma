...
<head>
    ...
    <!-- Plugins css -->
    <link rel="stylesheet" href="{{URL::asset('../assets/libs/flatpickr/flatpickr.min.css')}}" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" href="{{URL::asset('../assets/libs/selectize/css/selectize.bootstrap3.css')}}" rel="stylesheet" type="text/css" />
        ...
        <div class="navbar-custom">
            <div class="container-fluid">
                <ul class="list-unstyled topnav-menu float-right mb-0">
                    ...
                    <!-- <!-- class="dropdown d-none d-lg-inline-block topbar-dropdown">
                        <a class="nav-link dropdown-toggle arrow-none waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                    ...
                                    <form class="form-inline">
                                        <div class="form-group">
                                            <div class="input-group input-group-sm">
                                                <input type="text" class="form-control border" id="dash-daterange" readonly>
                                        ...
                                        <a href="#" class="btn btn-blue btn-sm ml-2" onclick="location.reload();">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-xl-3">
                            <div class="card-box">
                                ...
                                <h4 class="mt-0 font-15">Total Sales</h4>
                                <h2 class="text-primary my-3 text-center">Rs <span data-plugin="counterup">{{number_format($total_sales)}}</span></h2>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card-box">
                                <i class="fa fa-info-circle text-muted float-right" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="More Info"></i>
                                <h4 class="mt-0 font-15">Number of Customers</h4>
                                <h2 class="text-primary my-3 text-center"><span data-plugin="counterup">{{$total_count}}</span></h2>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card-box">
                                <i class="fa fa-info-circle text-muted float-right" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="More Info"></i>
                                <h4 class="mt-0 font-15">Total Paid</h4>
                                <h2 class="text-primary my-3 text-center">Rs <span data-plugin="counterup">{{number_format($total_paid)}}</span></h2>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card-box">
                                <i class="fa fa-info-circle text-muted float-right" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="More Info"></i>
                                <h4 class="mt-0 font-15">Total Percentage</h4>
                                <h2 class="text-primary my-3 text-center"><span data-plugin="counterup">{{round($ratio,0)}}</span>%</h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12">
                            <div class="card-box">
                                ...
                                <h4 class="header-title mb-3">Institutions List</h4>
                                <br>
                                <div class="table-responsive">
                                    <table class="table table-borderless table-nowrap table-hover table-centered m-0" id="example">
                                        ...
                                        @foreach($institutions as $institution)
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-0 font-weight-normal font-13">{{$institution->name}}</h5>
                                                </td>
                                                <td style="text-align: right">
                                                   {{$institution->total_loan_amount}}
                                                </td>
                                                ...
                                                <td style="text-align: center">
                                                    {{round($institution->percentage,0)}}%
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            </script> &copy; Textile Textile Systems by <a href="www.syscodtech.com" target="_blank">SysCodtech</a>
                        </div>
                        <div class="col-md-6">
