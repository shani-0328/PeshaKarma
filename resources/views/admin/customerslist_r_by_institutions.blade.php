                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row mb-2">
                                        <div class="col-sm-8">
                                        <h3 class="page-title">{{$institution->name}}</h3>
                                        <h4 class="page-title">{{$institution->address}}</h4>
                                        </div>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-centered table-striped table-hover dt-responsive nowrap w-100" id="myTable">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                              ...
                                              <tr>
                                                  ...
                                                  <td class="table-user">
                                                      ...
                                                      <a href="{{url('/admin/customer-details',$customer->id)}}" class="text-body font-weight-semibold">{{$customer->last_name}}</a>
                                                  </td>
                                                  <td>
                                                    {{$customer->Gov_ID}}  
                                                  </td>
