                                    ...
                                    {!! Form::model($user, ['method'=>'PATCH' , 'action'=>['App\Http\Controllers\UsersController@update',$user->id]]) !!}
                                        ...
                                        <div class="form-row">
                                          ...
                                          <small class = "text-danger">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                {!! Form:: number('phone_number', null,['class'=>'form-control', 'required'=> 'true', 'oninput'=>'javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);', 'maxlength'=> '10']) !!}
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                {!! Form:: password('password',['class'=>'form-control', 'required'=> 'true','id'=>'adduserpassword']) !!}
