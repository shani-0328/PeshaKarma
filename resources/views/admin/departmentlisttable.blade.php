...
<head>
    <meta charset="utf-8" />
    <title>Department - Textile </title>
...
<body>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="text-lg-right mt-3 mt-lg-0">
                                            <a href="{{url('/admin/departmentlisttable')}}" type="button" class="btn btn-success waves-effect waves-light mr-1"><i class="mdi mdi-format-list-bulleted"></i></a>
                                            <a href="{{url('/admin/departmentlist')}}" type="button" class="btn btn-light waves-effect waves-light mr-1"><i class="mdi mdi-view-dashboard-outline"></i></a>
                                        </div>
                                    </div>
                                    <!-- end col-->
                                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-centered table-striped dt-responsive nowrap w-100" id="department-datatable">
                                            <thead>
                                                <tr>
                                                    <th style="width: 20px;">
                                                    ...
                                                    <th style="text-align: center;">Precentage</th>
                                            ...
                                            @foreach($departments as $department)
                                                @foreach($departmentss as $departmentse)
                                                    @if($department->id == $departmentse->ID)
                                                <tr>
                                                    <td>
                                                        <div class="custom-control custom-checkbox">
                                                    ...
                                                    <td class="table-user">
                                                        ...
                                                        <a href="{{url('/admin/institutionlist', $department->id)}}" class="text-body font-weight-semibold">{{$department->name}}</a>
                                                    </td>
                                                    <td>
                                                    
                                                        <!-- {{$department->total_institutions}} -->
                                                        {{$departmentse->total_institutions}}
                                                    </td>
                                                    <td style="text-align: right;">
                                                        {{round($department->total_loan_amount,2)}}
                                                    </td>

                                                    <td style="text-align: center;">
                                                      {{round($department->percentage,0)}}%
                                                    </td>
                                                    <td style="text-align: center;">
                                                        <a href="{{url('/admin/institutionlist', $department->ID)}}" type="button" class="btn btn-success btn-sm waves-effect waves-light mr-1" data-toggle="tooltip" data-placement="top" title="View Institutions">Viwe</a>
                                                    </td>
    ...
    <!-- Datatables init -->
    <script src="{{URL::asset('../assets/js/pages/departmentlisttable.init.js')}}"></script>
