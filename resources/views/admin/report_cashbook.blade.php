...
<body>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row mb-2">
                                        <div class="col-sm-4">
                                        <p id="date_filter">
                            {!! Form::open(['method'=>'POST' , 'action'=>'App\Http\Controllers\ReportsController@SearchByDate']) !!}
        
                            {!! Form:: date('from', null,['class'=>'form-control', 'required'=> 'true', 'placeholder'=> 'From']) !!}
                            <br>
                            {!! Form:: date('to', null,['class'=>'form-control', 'required'=> 'true', 'placeholder'=> 'To']) !!}
                            <br>
                            <button type="submit" class="btn btn-primary">Fileter</button>
                            {!! Form::close() !!} 
    ...
    <!-- <span id="date-label-to" class="date-label">To:<input class="date_range_filter date" type="text" id="datepicker_to" /> -->
                                    ...
                                    <p>Total Paid Amount: <b><span id="total"></span></b></p>
                                        <table class="table table-striped dt-responsive nowrap w-100" id="example">
                                            ...
                                            @foreach($cashbooks as $cashbook)         
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{$cashbook->payment_date}}
                                                    </td>
                                                    <td>
                                                        {{$cashbook->i_code}}
                                                    </td>
                                                    <td>
                                                        {{$cashbook->institution}}
                                                    </td>
    ...
    buttons: [
            {
                ...
                customize: function ( win ) {
                    $(win.document.body)
                        .css( 'font-size', '12pt' )
                        .prepend(
                            '<h2 style="text-align: center;">Cash Book Report</h2><br><p><b>Total Paid Amount:</b> .......................................</p>'
                        );
