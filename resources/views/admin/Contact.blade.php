                        ...
                        <div class="col-">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row mb-2">
                                        <div class="col-sm-4">
                                            <a href="javascript:void(0);" class="btn btn-primary mb-2">All</a>
                                            <a href="javascript:void(0);" class="btn btn-light mb-2">Done</a>
                                            <a href="javascript:void(0);" class="btn btn-danger mb-2">Overdue</a>

                                        </div>
                                        <div class="col-sm-8">
                                            <div class="text-sm-right">
                                                <a href="javascript:void(0);" class="btn btn-danger mb-2">Send All</a>
                                            </div>
                                        </div>
                                        <!-- end col-->
                                    </div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="javascript:void(0);" class="action-icon"> <i class="mdi mdi-dots-horizontal-circle-outline"></i></a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                            ...
                            <div class="card-box">
                                <div class="media mb-3">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="">Manager</p>
                                        <p>Staus: 25000.00<span class="badge badge-soft-danger">Credit</span></p>
                                        <p class="text-muted"><i class="mdi mdi-office-building"></i> Health Department</p>
                                ...
                                <div class="">
                                    <h4 class="font-13 text-muted text-uppercase">Gov ID Number</h4>
                                    <p class="mb-3">
                                        780561278v
                                    </p>
                                    <h4 class="font-13 text-muted text-uppercase">Invoice Number</h4>
                                    <p class="mb-3">
                                        #12457
                                    </p>

                                    <h4 class="font-13 text-muted text-uppercase">value</h4>
                                    <p class="mb-3">
                                        Rs 78000.00
                                    </p>

                                    <h4 class="font-13 text-muted text-uppercase"># of Installment And value</h4>
                                    <p class="mb-3">
                                        24 months | Rs 10000/month
                                    </p>
                                    <h4 class="font-13 text-muted text-uppercase mb-1">Date :</h4>
                                    <p class="mb-3"> April 22, 2016</p>

                                    <h4 class="font-13 text-muted text-uppercase mb-1">Address :</h4>
                                    <p class="mb-3">505/30, Dharamapala Mawatha, Aruppala</p>

                                    <h4 class="font-13 text-muted text-uppercase mb-1">phone Number :</h4>
                                    <p class="mb-3">076 8945893</p>

                                    <h4 class="font-13 text-muted text-uppercase mb-1">Company :</h4>
                                    <p class="mb-3">Kandy Hospital</p>

                                    <h4 class="font-13 text-muted text-uppercase mb-1">Office phone Number :</h4>
                                    <p class="mb-3">081 8945893</p>

                                    <h4 class="font-13 text-muted text-uppercase mb-1">Dealing place :</h4>
                                    <p class="mb-3">Kandy Hospital</p>
