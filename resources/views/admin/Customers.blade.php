    ...
    <div id="wrapper">
        ...
        <div class="content-page">
            <div class="content">
				...
				<div class="alert alert-primary alert-dismissible fade show" role="alert">
                    <strong>Success!</strong> {{session('Add_invoice')}}
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row mb-2">
                                        <div class="col-sm-4">
                                            <a href="{{url('/admin/customers/create')}}" class="btn btn-danger mb-2"><i class="mdi mdi-plus-circle mr-2"></i> Add Customers</a>
                                        </div>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-centered table-striped dt-responsive nowrap w-100" id="managecustomers">
                                            <thead>
                                                <tr>
                                        ...
                                        @foreach($customers as $customer)
                                                <tr>
                                                    ...
                                                    <td class="table-user">
                                                        <a href="{{url('/admin/customer-details',$customer->id)}}" class="text-body font-weight-semibold " style="text-transform: uppercase;">{{$customer->initials}} {{$customer->last_name}}</a>
                                                    </td>
                                                    ...
                                                    <td>
                                                    {{$customer->invoice_first_invoice}}
                                                    </td>
                                                   ...
                                                   {{$customer->invoice_count}}
                                                    ...
                                                    <td>
                                                    <a href="{{url('/admin/customer-invoice/create',$customer->id)}}" type="button" class="btn btn-primary btn-sm"> <i class="mdi mdi-plus-circle"></i> Add Invoice</a>
                                                    </td>

                                                    <td>
                                                        <a href="{{route('customers.edit',$customer->id)}}" type="button" class="btn btn-link action-icon" data-toggle="tooltip" data-placement="top" title="Edit Customer"> <i class="mdi mdi-square-edit-outline"></i></a>
                                                        @if(auth()->user()->role->name == 'SuperAdmin')
                                                        <a href="{{url('/customer/delete', $customer->id)}}" class="button btn btn-link action-icon delete-confirm"><i class="mdi mdi-delete" data-toggle="tooltip" data-placement="top" title="Delete"></i></a>
                                                        @endif
                                                        <a href="{{url('/admin/customer-details',$customer->id)}}" type="button" class="btn btn-link action-icon" data-toggle="tooltip" data-placement="top" title="View"> <i class="mdi mdi-dots-horizontal-circle-outline"></i></a>
                                                    </td>
                                                </tr> 
