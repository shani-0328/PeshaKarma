        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="alert alert-info alert-dismissible fade show" role="alert">
                    <strong>Success!</strong> {{session('edit_user')}}
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row mb-2">
                                        <div class="col-sm-4">
                                            <a href="{{url('/admin/users/create')}}" class="btn btn-danger mb-2"><i class="mdi mdi-plus-circle mr-2"></i> Add Users</a>
                                        </div>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-centered table-striped dt-responsive nowrap w-100" id="usertable">
                                            <thead>
                                                <tr>
                                            ...
                                            @foreach($users as $user)
                                                <tr>
                                                    ...
                                                    @if($user->isOnline())
                                                    <td>
                                                    <span class="badge badge-success" data-toggle="tooltip" data-placement="top" title="{{$user->name}} Online">Online</span>
                                                    </td>
                                                    @else
                                                    <td>
                                                    <span class="badge badge-danger" data-toggle="tooltip" data-placement="top" title="{{$user->name}} Offline">Offline</span>
                                                    </td>
                                                    @endif
                                                    <td>
                                                    <!-- {!! Form::open(['method'=>'DELETE' , 'action'=>['App\Http\Controllers\UsersController@destroy',$user->id]]) !!} -->
                                                        <a href="{{route('users.edit',$user->id)}}" type="button" class="btn btn-link action-icon" data-toggle="tooltip" data-placement="top" title="Edit User"> <i class="mdi mdi-square-edit-outline"></i></a>
                                                        <a href="{{url('/user/delete', $user->id)}}" class="button btn btn-link action-icon delete-confirm"><i class="mdi mdi-delete" data-toggle="tooltip" data-placement="top" title="Delete User"></i></a>
