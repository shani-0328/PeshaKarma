                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="table-responsive" id="printableArea">
                                    <h4 class="page-title">{{$institution->department->name}}</h4>
                                    <h4 class="page-title">{{$institution->name}}</h4>
                                        <table class="table table-striped dt-responsive nowrap w-100 table-bordered" id="example">
                                            <thead>
                                                <tr>
                                                    
                                                    <th>Name</th>
                                                    
                                                    <th style="text-align: center;">1st In</th>
                                                    <th style="text-align: center">2ed In</th>
                                                    <th style="text-align: center">3ed In</th>
                                                    <th style="text-align: center">4th In</th>
                                                    <th style="text-align: center">5th In</th>
                                                    <th style="text-align: center">6th In</th>
                                                    <th style="text-align: center">8th In</th>
                                            ...
                                            @foreach($customers as $customer)
                                                <tr>
                                                    ...
                                                    <td style="text-align: left ; height: 100px; width: 250px;">
                                                    <b>{{$customer->Gov_ID}}</b> <br>{{$customer->initials}} {{$customer->last_name}} 
                                                    </td>
                                                    ...
                                                    <td style="text-align: right ; height: 100px; width: 120px;">
