...
<body>
                                            ...
                                            @foreach($institutions as $institution)
                                                <tr>
                                                    ...
                                                    <td class="table-user">
                                                        ...
                                                        <a href="{{url('/institution/customers',$institution->id)}}" class="text-body font-weight-semibold">{{$institution->name}}</a>
                                                    </td>
                                                    <td style="text-align: right;">
                                                      {{round($institution->total_loan_amount,2)}}
                                                    </td>
                                                    <td style="text-align: right;">
                                                        {{round($institution->paid,2)}}
                                                    </td>
                                                    <td style="text-align: right;">
                                                        {{round($institution->balance,2)}}
                                                    </td>
                                                    ...
                                                    <td style="text-align: center;">
                                                        <a href="{{url('/institution/customers',$institution->id)}}" type="button" class="btn btn-success btn-sm waves-effect waves-light mr-1">View</a>
                                                    </td>
    ...
    <!-- Datatables init -->
    <script src="{{URL::asset('../assets/js/pages/institutionlist.init.js')}}"></script>
