                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="mb-3 header-title">Edit Departments</h4>

                                    {!! Form::model($department, ['method'=>'PATCH' , 'action'=>['App\Http\Controllers\DepartmentController@update',$department->id]]) !!}
