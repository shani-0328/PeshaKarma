                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row mb-2">
                                        <div class="col-sm-4">
                                            <h4 class="page-title">Institutions Report</h4>
                                        </div>
                                        <div class="col-sm-8">
                                            ...
                                            @foreach($institutions as $institution)
                                                 @if ($institution->total_loan_amount != 0)
                                                    <tr>
                                                        ...
                                                        <td>
                                                        <b><a href="{{url('/admin/customers-report', $institution->id)}}" data-toggle="tooltip" data-placement="bottom" title="View">{{$institution->name}}</a></b>
                                                        </td>
