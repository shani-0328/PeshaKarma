...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    <h4 class="mb-3 header-title">Edit Payment</h4>

                    {!! Form::model($installment, ['method'=>'POST' , 'action'=>['App\Http\Controllers\PaymentController@installmentupdate',$installment->id]]) !!}
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                <label for="inputpost4" class="col-form-label">Amout</label>
                            ...
                            <select id="inpurinvoiceid" class="form-control" name="paid_option" required>
                                    ...
                                    <option   {{$installment->paid_option == "YR" ? 'selected': ''}} >YR</option>
                                    <option {{$installment->paid_option == "Cheque" ? 'selected': ''}}  >Cheque</option>
                                    <option {{$installment->paid_option == "Other" ? 'selected': ''}} >Other</option>
